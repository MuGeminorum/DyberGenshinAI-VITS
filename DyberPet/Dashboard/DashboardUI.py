...
class DashboardMainWindow(FluentWindow):
    ...
    def __init__(self, minWidth=620, minHeight=600):
        ...
        self.backpackInterface = backpackInterface(
            sizeHintdb=(minWidth, minHeight), parent=self
        )
        self.shopInterface = shopInterface(
            sizeHintdb=(minWidth, minHeight), parent=self
        )
    ...
    def __connectSignalToSlot(self):
        ...
        self.backpackInterface.coinWidget.coinUpdated.connect(
            self.shopInterface.coinWidget._update2data
        )
        self.backpackInterface.item_num_changed.connect(
            self.shopInterface._updateItemNum
        )
        # buy&sell
        ...
        self.taskInterface.progressPanel.addCoins.connect(
            self.backpackInterface.addCoins
        )
